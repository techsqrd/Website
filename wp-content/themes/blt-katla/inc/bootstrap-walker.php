    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
            ...
            if(strpos($class_names, 'fa-') !== false){
                ...
                preg_match('/fa fa\-[a-z-]+/',  $class_names, $icon_class);

                if(isset($icon_class[0])){
                    $class_names = str_replace($icon_class[0], '', $class_names);
                }
            ...
            if(isset($icon_class[0])){
                ...
                $item_output .= '<a'. $attributes .'><i class="'. $icon_class[0] . '"></i>&nbsp;&nbsp;';
