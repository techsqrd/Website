		...
		<div class="content-text"><?php 
			...
			switch (blt_get_option('show_content_or_excerpt', 'excerpt')) {
				...
				default:
                                    ...
                                    //wp_reset_postdata();
                                    //get_the_excerpt($post->id);
                                        //echo ' jashd ajsh dkasjh dkashdkjhaskjhdaksdkah sdj asd hkash da shdkh askdkash dkahs dahskd aksd kahs daskd askd aks dash dkahs';
                                        break;
			} ?>
	...
	<div class="content-footer clearfix">
		...
		if(blt_get_option('post_voting', true)){ 
                   //echo $post->ID;
                    ...
                    $score = get_post_meta( $post->ID, 'blt_score', true );
