	...
	class STATUS_Popular_Posts extends WP_Widget {
		...
		public function form( $instance ) {
			...
			<p>
				...
				<option value="DESC" <?php if( $order == 'DESC' ) { ?>selected="selected"<?php } ?>><?php esc_html_e( 'Descending', 'status' ); ?></option>
				<option value="ASC" <?php if( $order == 'ASC' ) { ?>selected="selected"<?php } ?>><?php esc_html_e( 'Ascending', 'status' ); ?></option>
				</select>
			</p>
